...
Fr_eq(&expaux[0],&expaux[1],&signalValues[mySignalStart + 3]); // line circom 12
...
Fr_mul(&expaux[1],&signalValues[mySignalStart + 2],&signalValues[mySignalStart + 3]); // line circom 13
Fr_eq(&expaux[0],&expaux[1],&signalValues[mySignalStart + 4]); // line circom 13
...
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 4]); // line circom 14
// end load src
